        ...
        <table style="font-size: 18px;">
            ...
            <?php 
                ...
                while($row = mysqli_fetch_assoc($stmt)) {
                    ...
                    <?php
                    echo "<td>$price</td>";
                    echo "<td><a href='product.php?source=edit_product&p_id={$pr_id}'>Edit</a> /  <a href='product.php?del_post={$pr_id}'>Delete</a>";
                    echo "</tr>";
              }
            ?>
        </table>
        ...
        <table style="font-size: 18px;">
            ...
            <?php 
                ...
                while($row = mysqli_fetch_assoc($stmt)) {
                    ...
                    <?php
                    echo "<td>$price</td>";
                    echo "<td> <a href='product.php?del_post={$pr_id}'>Delete</a>";
                    echo "</tr>";
              }
            ?>
        </table>
