...
<div class="loginbox rounded">
    ...
    <form action="#" method="POST"><br>
        ...
        <input type="url" id="image" name="image" value="<?php echo $product_image ?>">
    ...
    <?php 
        if(isset($_POST['updateproduct'])) {
            ...
            $price = $_POST['price'];
            $image = $_POST['image'];
            $update_query = "UPDATE products SET product_image = '$image', product_cate_id = '$categoryid', product_name = '$name', product_price = '$price' WHERE product_id = $id";
