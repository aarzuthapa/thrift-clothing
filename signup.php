        ...
        <div class="products rounded col">
            ...
            <div class="loginbox rounded signup">
                ...
                <form action="#" method="POST"><br>
                    ...
                    <input type="text" id="email" name="email" placeholder="Enter Email" style="color: #fff;" required>
                ...
                if (isset($_POST['reg_user'])) {
                    ...
                    if (mysqli_num_rows($duplicate) > 0) {
                        ...
                        window.location = 'http://localhost/onlinemask/signup.php';
                        </script>";
                    } else {
                        ...
                        window.location = 'http://localhost/onlinemask/login.php';
                        </script>";
